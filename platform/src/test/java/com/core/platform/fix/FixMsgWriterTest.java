...
public class FixMsgWriterTest {
    ...
    void write_tags() {
        ...
        then(fixMsg.getTagAt(12)).isEqualTo(60);
        then(fixMsg.getTagAt(13)).isEqualTo(10);
        ...
        then(fixMsg.getValueAt(12)).isEqualTo(BufferUtils.fromAsciiString("20210526-09:30:06.123"));
        //then(fixMsg.getValueAt(13)).isEqualTo();

        then(fixMsg.getSize()).isEqualTo(14);
    }
}
