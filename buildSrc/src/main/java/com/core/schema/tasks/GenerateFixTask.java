...
import com.core.schema.FixGenerator;
...
/**
 * Gradle task to run FIX schema generator.
 */
public class GenerateFixTask extends DefaultTask {
    ...
    public void generate() throws Exception {
        FixGenerator.generate(getSchemaXml(), getOutputDir());
    }
}
